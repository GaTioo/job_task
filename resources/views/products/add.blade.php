                    ...
                    <div class="card">
                        <form method="POST" action="{{ route('products.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="unit_price" type="text" class="form-control @error('unit_price') is-invalid @enderror" name="unit_price" value="{{ old('unit_price') }}" required autocomplete="unit_price" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="currency_id" type="text" class="form-control @error('currency_id') is-invalid @enderror" name="currency_id" value="{{ old('currency_id') }}" required autocomplete="currency_id" autofocus>
